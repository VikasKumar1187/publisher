...
// Errors handles errors coming out of the call chain. It detects normal application errors which are used
// to respond to the client in a uniform way.Unexpected errors (status >= 500) are logged.
